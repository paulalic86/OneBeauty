...
//
	...
	$( "#slider-range, #slider-range2" ).slider({
      ...
      slide: function( event, ui ) {
        $( "#amount, #amount2" ).val(  ui.values[ 0 ] + " c.c." + ui.values[ 1 ] + " c.c.");
      }
    });
    $( "#amount, #amount2" ).val(  $( "#slider-range, #slider-range2" ).slider( "values", 1 )+"c.c." +
        $( "#slider-range, #slider-range2" ).slider( "values", 0 ) +" c.c.");
